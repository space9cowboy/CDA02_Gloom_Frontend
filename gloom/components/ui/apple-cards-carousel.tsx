...
export const Card = ({
  ...
  const handleCardClick = () => {
    router.push(`/instrument/category/${card.category}`); // Rediriger vers la catégorie spécifique
  };

  return (
    <motion.button
      layoutId={layout ? `card-${card.title}` : undefined}
      onClick={handleCardClick} // Remplacer handleOpen par la redirection
      className="rounded-3xl bg-gray-100 dark:bg-neutral-900 h-[150px] w-56 md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10"
    >
